...
export default function SafetyComparisonPanel() {
  ...
  if (!active) return <Panel><div className="vs-root">No Visual Safety cases are available.</div></Panel>;
